...
import { Calendar as CalendarIcon, Clock, MapPin, Users, ArrowRight, Loader2 } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            {loading ? (
              ...
              events.map((event) => (
                <Card key={event.id} className="border-none shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col md:flex-row">
