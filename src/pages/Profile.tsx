...
const Profile = () => {
  ...
  // Apenas este e-mail terá acesso ao botão de promoção
  ...
  const makeMeAdmin = async () => {
    ...
    try {
      ...
      showError('Erro ao promover cargo. Verifique as políticas RLS no Supabase.');
    } finally {
      setPromoting(false);
    }
  };
    ...
    <Layout>
      <div className="max-w-2xl mx-auto space-y-8">
        <div className="flex justify-between items-end">
          ...
          {/* O botão só aparece se você não for admin E for o e-mail MASTER_EMAIL */}
            ...
            <form onSubmit={handleUpdateProfile} className="mt-8 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <Button 
                  ...
                  onClick={() => signOut()}
                >
                  <<dyad-write path="src/pages/Profile.tsx" description="Completando o arquivo de perfil com a restrição de e-mail e botão de promoção.">
"use client";
